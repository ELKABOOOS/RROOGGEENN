...
if tonumber(user_id) == tonumber(1851380322) then  
var = 'مــبـرمـج سـورس روجــيـن'
elseif tonumber(user_id) == tonumber(1839082644) then
var = 'مــبـرمـج سـورس روجــيـن'
elseif tonumber(user_id) == tonumber(1744196893) then
var = 'مــطـور سـورس روجــيـن'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "المطور الثانوي"  
...
{'بايو'},
{'┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄'},
{'كت تويت بالصوره','لو خيروك بالصوره'},
{'┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄'},
{'العاب روجين'},
{'┄─━━━━𝗿𝗼𝗼𝗴𝗲𝗻━━━━─┄'},
{'ثيم','صور انيمي'},
...
local Text = [[ 
 ◉قناه مبرمجين سورس روجين
محتاج تنصب بوت حمايه ببلاش تواصل معانا⇓⇓
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مبرمجين ❍ السورس', url="t.me/U880p"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_, msg.id_,' رتـبـتـك ← '..rtp)
end
...
local Teext =[[
 ◉أنت الآن في العاب مميزات سورس روجين ◉
اتبع الازار الي في الاسفل⇣
]]
keyboard = {} 
keyboard.inline_keyboard = {
